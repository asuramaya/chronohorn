#!/usr/bin/env python3
"""Train PolyHash v8h — Hybrid Decepticon (hash pyramid + tiny scan)."""
...
from chronohorn.families.polyhash.models.polyhash_v8h import PolyHashV8H, V8HConfig
...
def main():
    ...
    result = {"model": {"test_bpb": fbpb, "test_bits_per_token": fbpt, "test_eval_loss": al,
        "params": params, "architecture": "polyhash_v8h"},
        "config": {"train": {"steps": args.steps, "seq_len": args.seq_len,
            "batch_size": args.batch_size, "learning_rate": args.lr,
            "num_scales": num_scales, "scan_dim": args.scan_dim,
            "hidden_dim": args.hidden, "num_layers": args.mlp_layers,
            "buckets_per_scale": args.buckets}},
