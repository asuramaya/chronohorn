...
pub struct OracleTargetProvenance {
    ...
    #[serde(default)]
    pub source_radius: Option<usize>,
    #[serde(default)]
...
pub struct OracleTargetStats {
    ...
    #[serde(default)]
    pub bidirectional_support_size: usize,
    #[serde(default)]
    pub left_only_support_size: usize,
    #[serde(default)]
    pub support_gap: isize,
    #[serde(default)]
    pub candidate_leq_2: bool,
    #[serde(default)]
    pub candidate_leq_4: bool,
    #[serde(default)]
    pub candidate_leq_8: bool,
    #[serde(default)]
...
pub fn bridge_doctrine() -> BridgeDoctrine {
    BridgeDoctrine {
        ...
        doctrine: "chronohorn is a causal compressor trained and shaped by a noncausal oracle, with the oracle excluded from runtime and the runtime attacked until the gain survives",
        roles: [
            SystemRole::Oracle,
...
pub fn clean_candidate4_target(
    ...
    OracleBridgeTarget {
        ...
        radius,
        candidate_k: 4,
        score: left_only_fraction - self_inclusion_uplift,
        stats: OracleTargetStats {
            ...
            bidirectional_support_size: 0,
            left_only_support_size: 0,
            support_gap: 0,
            candidate_leq_2: false,
            candidate_leq_4: true,
            candidate_leq_8: false,
            memory_trust: 0.0,
