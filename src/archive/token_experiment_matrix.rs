...
use super::token_copy_bridge::train_token_copy_bridge_from_data_root;
use super::token_match_bridge::train_token_match_bridge_from_data_root;
use super::token_matchcopy_bridge::train_token_matchcopy_bridge_from_data_root;
use super::token_matchskip_bridge::train_token_matchskip_bridge_from_data_root;
use super::token_matchskipcopy_bridge::train_token_matchskipcopy_bridge_from_data_root;
use super::token_skip_bridge::train_token_skip_bridge_from_data_root;
...
fn row_from_match(
    report: &super::token_match_bridge::TokenMatchBridgeReport,
    byte_accounting: Option<&ByteAccountingReport>,
) -> MatrixRow {
...
fn row_from_skip(
    report: &super::token_skip_bridge::TokenSkipBridgeReport,
    byte_accounting: Option<&ByteAccountingReport>,
) -> MatrixRow {
    let primary_bpt = match report.selected_runtime_gate.as_str() {
        "heuristic" => report.eval_bpt_heuristic,
...
fn row_from_copy(
    report: &super::token_copy_bridge::TokenCopyBridgeReport,
    byte_accounting: Option<&ByteAccountingReport>,
) -> MatrixRow {
    let primary_bpt = match report.selected_runtime_gate.as_str() {
        "heuristic" => report.eval_bpt_heuristic,
...
fn row_from_matchskip(
    report: &super::token_matchskip_bridge::TokenMatchSkipBridgeReport,
    byte_accounting: Option<&ByteAccountingReport>,
) -> MatrixRow {
    let primary_bpt = match report.selected_runtime_gate.as_str() {
        "heuristic" => report.eval_bpt_heuristic,
...
fn row_from_matchcopy(
    report: &super::token_matchcopy_bridge::TokenMatchCopyBridgeReport,
    byte_accounting: Option<&ByteAccountingReport>,
) -> MatrixRow {
    let primary_bpt = match report.selected_runtime_gate.as_str() {
        "heuristic" => report.eval_bpt_heuristic,
...
fn row_from_matchskipcopy(
    report: &super::token_matchskipcopy_bridge::TokenMatchSkipCopyBridgeReport,
    byte_accounting: Option<&ByteAccountingReport>,
) -> MatrixRow {
    let primary_bpt = match report.selected_runtime_gate.as_str() {
        "heuristic" => report.eval_bpt_heuristic,
